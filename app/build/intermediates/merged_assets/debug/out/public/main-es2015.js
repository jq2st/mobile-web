...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: ':id',
                loadChildren: () => Promise.all(/*! import() | detailed-detailed-module */[__webpack_require__.e("common"), __webpack_require__.e("detailed-detailed-module")]).then(__webpack_require__.bind(null, /*! ./detailed/detailed.module */ "./src/app/detailed/detailed.module.ts")).then(m => m.DetailedPageModule)
            }
        ]
    },
    {
